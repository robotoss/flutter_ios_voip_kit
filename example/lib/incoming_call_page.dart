...
class _IncomingCallPageState extends State<IncomingCallPage> {
  ...
  void initState() {
    ...
    voIPKit.onDidReceiveIncomingPush = (
      ...
      debugPrint('🎈 example: onDidReceiveIncomingPush $payload');
      _timeOut();
    };
    ...
    voIPKit.onDidRejectIncomingCall = (
      ...
      debugPrint('🎈 example: onDidRejectIncomingCall $uuid, $callerId');
      voIPKit.endCall();
      timeOutTimer?.cancel();
    ...
    voIPKit.onDidAcceptIncomingCall = (
      ...
      debugPrint('🎈 example: onDidAcceptIncomingCall $uuid, $callerId');
